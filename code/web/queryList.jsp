...
<head>
    ...
    <script type="text/javascript">
        function selPage_onchange(){
            ...
            location.href="queryList?page="+pageNum;
        }
    </script>
</head>
        ...
        <div class="right">
            <div style="text-align: center;">
                ...
                <table class="table_context">
                    ...
                    <%
                        PageBean<Contracts> pageBean= (PageBean<Contracts>) request.getAttribute("pageBean");
                ...
                <div class="selectDiv">
                    ...
                    <div class="selectPage">
                        <%if(pageNum>1){%>
                        <a href="queryList?page=1">第一页</a>&nbsp;&nbsp;
                        <a href="queryList?page=<%=pageNum-1%>">上一页</a>&nbsp;&nbsp;
                        <%}else{%>
                        第一页&nbsp;&nbsp;上一页&nbsp;&nbsp;
                        <%} %>
                        <%if(pageNum<totalPage){%>
                        <a href="queryList?page=<%=pageNum+1%>">下一页</a>&nbsp;&nbsp;
                        <a href="queryList?page=<%=totalPage%>">最后一页</a>&nbsp;&nbsp;
                        <%}else{%>
                        下一页&nbsp;&nbsp;最后一页&nbsp;&nbsp;
                        <%} %>
                        转到第
