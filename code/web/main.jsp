...
<head>
    ...
    <script type="text/javascript">
        function selPage_onchange(){
            ...
            location.href="main?page="+pageNum;
        }
    </script>
</head>
                ...
                <div class="selectDiv">
                    ...
                    <c:if test="${not empty pageBean}">
                        ...
                        <div class="selectPage">
                                <%--<%if(pageNum>1){%>
                                <a href="main.do?page=1">第一页</a>&nbsp;&nbsp;
                                <a href="main.do?page=<%=pageNum-1%>">上一页</a>&nbsp;&nbsp;
                                <%}else{%>
                                第一页&nbsp;&nbsp;上一页&nbsp;&nbsp;
                                <%} %>--%>
                            <c:choose>
                                <c:when test="${pageBean.pageNum>1}">
                                    <a href="main?page=1">第一页</a>&nbsp;&nbsp;
                                    <a href="main?page=${pageBean.pageNum-1}">上一页</a>
                                </c:when>
                                <c:otherwise>
                                    第一页&nbsp;&nbsp;上一页&nbsp;&nbsp;
                                </c:otherwise>
                                ...
                                <%--    <%if(pageNum<totalPage){%>
                                  <a href="main.do?page=<%=pageNum+1%>">下一页</a>&nbsp;&nbsp;
                                  <a href="main.do?page=<%=totalPage%>">最后一页</a>&nbsp;&nbsp;
                                  <%}else{%>
                                  下一页&nbsp;&nbsp;最后一页&nbsp;&nbsp;
                                  <%} %>--%>
                            <c:choose>
                                <c:when test="${pageBean.pageNum<pageBean.totalPage}">
                                    <a href="main?page=${pageBean.pageNum+1}">下一页</a>&nbsp;&nbsp;
                                    <a href="main?page=${pageBean.totalPage}">最后一页</a>
                                </c:when>
                                <c:otherwise>
                                    下一页&nbsp;&nbsp;最后一页&nbsp;
                                </c:otherwise>
