...
<div class="all">
    ...
    <div  class="main">
        ...
        <div class="right">
            <h2>添加联系人</h2>
            <form  method="post" action="addContracts" onsubmit="return MyCheck()">
                <table border="0" cellpadding="0" cellspacing="0" width="80%" style="margin-left: 80px;">
                    ...
                    <tr>
                        ...
                        <td width="25%" height="30" align="left">
                            <input id="age" name="age" type="text" maxlength="20"class="input" onkeypress="if((event.keyCode>=48)&&(event.keyCode <=57)) {event.returnValue=true;} else{event.returnValue=false;}">
                        </td>
