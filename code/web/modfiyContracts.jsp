...
<div class="all">
    ...
    <div  class="main">
        ...
        <div class="right">
            <h2>修改联系人</h2>
            <form  method="post" action="saveModfiy" onsubmit="return MyCheck()">
                <table border="0" cellpadding="0" cellspacing="0" width="80%" style="margin-left: 80px;">
                    <tr>
                        ...
                        <td width="25%" height="30" align="left">
                            <div style="float: left;">
                                <c:choose>
                                    <c:when test="${requestScope.contracts.sex=='男'}">
                                        <div class="radio">
                                    ...
                                    <c:otherwise>
                                        <div class="radio">
                                            <input id="sex3" name="sex" type="radio" value="男" class="radio_type" /><label class="radio-label">男&nbsp;&nbsp;</label>
                                        </div>
                                        <div class="radio">
                                            <input id="sex4" name="contracts.sex" type="radio" value="女" class="radio_type" checked/><label class="radio-label">女</label>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
                    ...
                    <tr>
                        ...
                        <td width="25%" height="30" anumber" type="text" value="<%=getNotNullString(contracts.getNumber())%>" maxlength="13" class="input" OnKeyPress="if((event.keyCode>=48)&&(event.keyCode <=57) || event.keyCode==45) {event.returnValue=true;} else{event.returnValue=false;}" style="ime-mode:Disabled">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="25%" height="30" align="left">
                            <div style="float: left;">
                                <c:choose>
                                    <c:when test="${requestScope.contracts.role=='个人'}">
                                        <div class="radio">
                                    ...
                                    <c:otherwise>
                                        <div class="radio">
                                            <input id="role3" name="role" type="radio" value="个人" class="radio_type" /><label class="radio-label">个人&nbsp;</label>
                                        </div>
                                        <div class="radio">
                                            <input id="role4" name="role" type="radio" value="企业" class="radio_type" checked/><label class="radio-label">企业</label>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
                        </td>
